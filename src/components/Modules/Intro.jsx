...
export default function Intro() {
	return (
		<div className="m-6 text-slate-700 flex-1">
			...
			<p className="py-3">
				I'm currently (re)learning React and building this website to help me practice. I'm focusing on proper
				react development practice and trying to learn more about how I can work with APIs as well
			</p>
			<p>If you have any feedback on the site, book recommendations, or just want to chat, please reach out!</p>
			<SocialMediaList />
		</div>
	);
}
